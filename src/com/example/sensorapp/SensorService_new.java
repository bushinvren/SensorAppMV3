...
public class SensorService_new extends Service {
	private IBinder binder = new SensorService_new.LocalBinder();
	...
	public void onDestroy() {
		...
		localIntent.setClass(this, SensorService_new.class); // 销毁时重新启动Service
	...
	public class LocalBinder extends Binder {
		// 返回本地服务
		public SensorService_new getService() {
			return SensorService_new.this;
		}
	}
